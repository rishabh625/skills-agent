...
variable "host_connection_name" {
  ...
  type        = string
  default     = "skills-agent-github-connection"
}
...
variable "github_token" {
  description = "GitHub token used by the Terraform GitHub provider to manage repo Actions variables/secrets (set via TF_VAR_github_token or GITHUB_TOKEN)."
  type        = string
  sensitive   = true
}
...
variable "feedback_logs_filter" {
  ...
  default     = "jsonPayload.log_type=\"feedback\" jsonPayload.service_name=\"skills-agent\""
}
